...
/* Peripheral Definitions for peripheral AXI_GPIO_SLAVE_0 */
#define XPAR_AXI_GPIO_SLAVE_0_BASEADDR 0x40000000
#define XPAR_AXI_GPIO_SLAVE_0_HIGHADDR 0x7FFFFFFF
